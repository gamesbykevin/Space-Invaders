package com.gamesbykevin.invaders.engine;

import com.gamesbykevin.invaders.main.Main;
import com.gamesbykevin.invaders.manager.Manager;
import com.gamesbykevin.invaders.menu.CustomMenu;
import com.gamesbykevin.invaders.resources.*;
import com.gamesbykevin.invaders.shared.Shared;
...
public final class Engine implements KeyListener, MouseMotionListener, MouseListener, IEngine 
{
    ...
    private void renderMenu(Graphics graphics) throws Exception
    {
        ...
        graphics.setFont(resources.getFont(GameFont.Keys.Menu).deriveFont(18f));
